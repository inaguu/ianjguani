            ...
            <div id='content'>
                <div className='col self-center flex-1 md:flex-row md:slef-stretch justify-center lg:justify-between items-center p-y-0px p-x-10px'>
                    <div className='md:flex-1 gap-10px'>
                        <h1 className='font-black tracking-[4px] text-center text-2.5em sm:text-[3em] md:text-[3.5em] lg:text-[4em] md:text-left '>Ian Jeremy Guani,</h1>
                        <p className='text-[var(--tertiary-text)] text-center md:text-left text-[1.2em] font-extralight'>
